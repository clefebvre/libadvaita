      ...
      char *argv[])
{
  ...
  g_test_add_func("/Advaita/PreferencesWindow/add_remove", test_adw_preferences_window_add_remove);
  g_test_add_func("/Advaita/PreferencesWindow/add_toast", test_adw_preferences_window_add_toast);
